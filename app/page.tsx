...
import { BentoGrid,BentoGridItem } from "./home/components/ui/bento-grid";
import {
...
import { WavyBackground } from "./home/components/ui/wavy-background";
import { ButtonsCard } from "./home/components/ui/tailwindcss-buttons";
      ...
      >
        ...
        >
          ...
          <p className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">
            Adjust routes to avoid weather-related risks.
          </p>
        ...
        <motion.div className="h-full relative z-20 w-1/3 rounded-2xl bg-white p-4 dark:bg-black dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center">
          ...
          />
          <p className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">
          Fetch and analyze weather data in real-time.
        ...
        >
          ...
          />
          <p className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">
          Issue alerts for smooth and safe navigation.
  ...
  const SkeletonFive = () => {
    ...
    return (
      ...
      >
        ...
        >
          <p className="text-xs text-neutral-500">Submit data directly to the backend API for immediate processing.
  ...
  const items = [
    {
      ...
      description: (
        <span className="text-sm">
          Calculate and visualize the most efficient shipping routes based on various parameters.
        </span>
      ),
      header: <SkeletonOne />,
    ...
    },
    {
      ...
      description: (
        <span className="text-sm">
          Input and utilize specific ship parameters for tailored route optimization.
    ...
    },
    {
      ...
      description: (
        <span className="text-sm">
          Integrate real-time wind vector data to enhance route safety and efficiency.
    ...
    },
    {
      ...
      description: (
        <span className="text-sm">
          Automatically adjust routes in real-time based on changing weather conditions to ensure optimal safety and efficiency.
        </span>
      ),
      header: <SkeletonFour />,
   ...
   
    {
      ...
      description: (
        <span className="text-sm">
          Submit ship and environmental parameters for real-time route calculation.
  ...
  return (
    <WavyBackground className="max-w-4xl mx-auto pb-40">
      ...
      <h2 className="text-4xl md:text-2xl lg:text-4xl font-semibold max-w-7xl mx-auto text-center mt-6 relative z-20 py-6 bg-clip-text text-transparent bg-gradient-to-b from-neutral-800 via-neutral-700 to-neutral-700 dark:from-neutral-800 dark:via-white dark:to-white">
        <Cover>Navigate</Cover> the Future, <Cover>Sail</Cover> with Precision
      </h2>
    </div>
        <br />
        <br />
